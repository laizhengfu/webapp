    ...
    (function() {
        $.fn.pageSlider = function(option) {
            ...
            $slider.on('touchstart', function(e) {
                ...
                $items.eq(curItemIndex).css('-webkit-transform', 'translate3d(0, ' + stepY + 'px, 0)');
                //缩小当面页
                ...
                if (Math.abs(stepY) > sliderHeight * opts.slidePercent) {
                    ...
                    $items.eq(curItemIndex).addClass('animate').css('-webkit-transform', 'translate3d(0, ' + (stepY > 0 ? sliderHeight : -sliderHeight) + 'px, 0)');
                    ...
                    $items.eq(animateItemIndex).addClass('animate').css('-webkit-transform', 'translate3d(0, ' + (stepY > 0 ? -sliderHeight : sliderHeight) + 'px, 0)');
                    setTimeout(function() {
                        $items.eq(animateItemIndex).removeClass('animate').css({
                        '-webkit-transform': '',
                        'opacity': ''
                    });
            ...
            function moveToNext() {
                ...
                $items.eq(curItemIndex).addClass('animate').css('-webkit-transform', 'translate3d(0, -' + sliderHeight + 'px, 0)');
                setTimeout(function() {
                    $items.eq(curItemIndex).removeClass('current');
